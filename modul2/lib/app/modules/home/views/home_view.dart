      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Tombol menuju Katalog Produk (Fitur Utama)
            ElevatedButton.icon(
              onPressed: () => Get.toNamed('/product-catalog'),
              icon: const Icon(Icons.shopping_bag),
              label: const Text('Katalog Produk Dinamis'),
            ...
            const Text('Demo Lainnya:', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
            const SizedBox(height: 8),
